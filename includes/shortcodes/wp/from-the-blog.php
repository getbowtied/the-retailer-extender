...
function tr_ext_shortcode_from_the_blog($atts, $content = null) {
    ...
    <div class="from-the-blog-section <?php if ( $title=='' ) echo 'slider-without-title'?>">
        ...
        <div class="slider-wrapper from-the-blog-wrapper swiper-container">
			<div class="swiper-wrapper slider">
                    ...
                    if ( $recentPosts->have_posts() ) : ?>
                        ...
                        <?php while ( $recentPosts->have_posts() ) : $recentPosts->the_post(); ?>
                            ...
                            <div class="swiper-slide from_the_blog_item <?php echo $post_format; ?> <?php if ( !has_post_thumbnail()) : ?>no_thumb<?php endif; ?>">
