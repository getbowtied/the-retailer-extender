...
function getbowtied_mc_shortcode_recent_products_mixed($atts, $content = null) {
...
add_shortcode("recent_products_mixed", "getbowtied_mc_shortcode_recent_products_mixed");