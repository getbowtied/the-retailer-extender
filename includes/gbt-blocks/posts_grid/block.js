			...
			return [
				...
				el( 'div',
					...
					el(
						'div',
						{
							key: 		'gbt_18_tr_editor_posts_grid_wrapper',
							className: 	'gbt_18_tr_editor_posts_grid_wrapper columns-' + attributes.columns,
						},
