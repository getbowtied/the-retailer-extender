	...
	*/
	public function __construct() {
		...
		parent::__construct(
			...
			__('Social Media Profiles', 'theretailer-extender'),
			array( 
				'classname' 	=> 'the_retailer_connect',
				'description' 	=> __('A widget that displays customized social icons ', 'theretailer-extender'),
			)
		);
	}
	...
	*/
	public function form( $instance ) {
		...
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'The Retailer Connect', 'theretailer-extender' );
		}
		?>
