		...
		public function tr_social_sharing_customizer( $wp_customize ) {
			...
			$wp_customize->add_control(
				new WP_TR_Customize_Toggle_Control(
					...
					array(
						'label'       	=> esc_attr__( 'Social Media Sharing', 'theretailer-extender' ),
						'section'     	=> 'product',
						'priority'    	=> 11,
					)
				)
		        ...
		        <ul>
		        	<li>
			            <a href="https://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>"
							...
							<span><span><?php esc_html_e('Share', 'theretailer-extender'); ?></span> <?php esc_html_e('on Facebook', 'theretailer-extender'); ?></span>
			            </a>
			        </li>
			        ...
			        <li>
			            <a href="//pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php echo $thumbnail_src[0]; ?>&description=<?php strip_tags(the_title()); ?>"
							...
							<span><span><?php esc_html_e('Pin', 'theretailer-extender'); ?></span> <?php esc_html_e('this item', 'theretailer-extender'); ?></span>
			            </a>
			        </li>
			        ...
			        <li>
			            <a href="mailto:enteryour@addresshere.com?subject=<?php strip_tags(the_title()); ?>&body=<?php echo strip_tags(apply_filters( 'woocommerce_short_description', $post->post_excerpt )); ?> <?php the_permalink(); ?>"
							...
							<span><span><?php esc_html_e('Email', 'theretailer-extender'); ?></span> <?php esc_html_e('a friend', 'theretailer-extender'); ?></span>
			            </a>
			        </li>
			        ...
			        <li>
			            <a href="https://twitter.com/share?url=<?php the_permalink(); ?>"
							...
							<?php _e('<span><span>Tweet</span> this item</span>', 'theretailer-extender'); ?>
			            </a>
			        </li>
		        </ul>
		...
		public function getbowtied_single_share_post() {
			...
			<div class="box-share-container post-share-container">
				<a class="trigger-share-list tr_upper_link" href="#">
					...
					<?php _e( 'Share this post', 'theretailer-extender' )?>
				</a>
